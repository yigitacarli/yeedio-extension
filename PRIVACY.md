...
Yeedio does not collect, sell, or transmit personal data. It has no analytics, advertising, account system, or external service.

The extension stores the selected speed and volume values in Chrome's local extension storage. This data stays in the browser profile and can be removed by uninstalling the extension or clearing its data.
